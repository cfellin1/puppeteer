...
class FrameManager extends EventEmitter {
  ...
  constructor(client, frameTree, page) {
    ...
    this._client.on('Page.lifecycleEvent', event => this.emit(FrameManager.Events.LifecycleEvent));
    this._eventListeners = [
      helper.addEventListener(this._client, Connection.Events.LifecycleEvent, () => this.emit(Connection.Events.LifecycleEvent))
    ];
